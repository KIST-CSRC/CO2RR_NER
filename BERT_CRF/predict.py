...
best_model_path = './matbert_new_kfold_500_crf_no_str_IOBES_20220713/seed5/0/best.pt'
save_dir = best_model_path.split('/')[1]+'_'+best_model_path.split('/')[2]+'_'+best_model_path.split('/')[3]+'/'
datafile = f"./CO2RR_NER/predict/total_dataset_y1.csv"
...
for model_name in ['matbert']:
    for i in range(0, len(data)):
        ...
        new_save_dir = './CO2RR_NER/predict/220818/'+ save_dir
